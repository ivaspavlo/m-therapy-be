import { IConfirmBookingEmail, IEmailTemplate } from '../../interfaces';

export const GetConfirmBookingTemplate = (templateData: IEmailTemplate<IConfirmBookingEmail>) => {
  return {
...
const buildTemplate = (templateData: IEmailTemplate<IConfirmBookingEmail>): string => {
  return `
                              ...
                              <table class="row__table" width="100%" align="center" role="presentation" border="0" cellpadding="0" cellspacing="0" style="table-layout: fixed;">
                                <tr class="row__row">
                                  <td class="column col-sm-12" width="700" style="padding: 0 10px;width: 100%" align="left" valign="top">
                                    ...
                                    <h2 id="email-title" class="email-title header h2" style="margin: 20px 0; line-height: 30px; font-family: Helvetica,Arial,sans-serif; color: #044E3B; text-align: center;">${ templateData.title }</h2>
                                  </td>
                                </tr>
                              </table>
                            </div>
