                                ...
                                <tr class="row__row">
                                  <td class="column col-sm-12" width="700" style="padding: 0 10px;width: 100%" align="left" valign="top">
                                    ...
                                    <h5 class="email-message header h5" style="margin: 20px 0; line-height: 17px; font-family: Helvetica,Arial,sans-serif; color: #044E3B;">
                                      ...
                                      <span style="display: block;">${
                                        templateData.comment ?? "_"
                                      }</span>
                                    </h5>
                                      <span>${bookingSlotsRendered}</span>
                                      <a class="main-link a" style="margin-bottom: 24px; color: #8AC343; display: inline-block;">
                                        <span class="a__text" style="color: #8AC343;">Перейти за посиланням</span>
                                      </a>
                                  </td>
                                </tr>
                              </table>
